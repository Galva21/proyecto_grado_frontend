...
const kPrimaryColor = Color(0xFF6c2e71);
const kPrimaryLightColor = Color(0xFFF1E6FF);
const kSecondColor = Color(0xFF006fa6);
const kThirdColor = Color(0xFF7b5ddf);
const kFourdColor = Color(0xFF00563f);
const kBackgroundColor = Color(0xFF311625);
