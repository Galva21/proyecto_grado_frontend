...
class GetAdoptantes extends StatefulWidget {
  const GetAdoptantes({Key? key}) : super(key: key);

  @override
  State<GetAdoptantes> createState() => _GetAdoptantesState();
}

class _GetAdoptantesState extends State<GetAdoptantes> {
  bool cargando = true;
  @override
  void initState() {
                          ...
                          showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialogSiNo(
                                mensaje:
                                    "¿Seguro desea eliminar este adoptante?",
                                onTap: () async {
                                  bool query = await API().eliminar_adoptante(
                                      provider.adoptantes[index].id);
                                  if (query) {
                                    Fluttertoast.showToast(
                                      msg: "Adoptante eliminado con exito",
                                    ...
                                    Fluttertoast.showToast(
                                      msg:
                                          "Ocurrio un problema al eliminar al adoptante",
                                      toastLength: Toast.LENGTH_SHORT,
                                      gravity: ToastGravity.TOP,
